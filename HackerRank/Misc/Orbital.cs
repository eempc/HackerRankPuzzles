...
namespace HackerRank.Misc {
    class Orbital {
        readonly static int massEarth = (int)(5.97237 * Math.Pow(10, 24)); // kg
        readonly static double G = 6.67430 * Math.Pow(10, -11); // m^3/(kg*s^2)
        readonly static double muEarth = 3.9860004418 * Math.Pow(10, 14); // m^3/s^2
        public const double earthRadius = 6371000; // m (mean)  cognate with semi-major axis
